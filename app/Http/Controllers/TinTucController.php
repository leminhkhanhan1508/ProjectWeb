    ...
    public function postSua(Request $request, $id)
    {
     ...
     $this -> validate($request,
    	...
    	if($request->hasFile('Hinh'))
    	{
    		...
    		if($duoi != 'jpg' && $duoi != 'png' && $duoi != "jpeg" )
    		{
    			return redirect('admin/loaitin/them') -> with('loi', 'Bạn chỉ được chọn file có đuôi jpg,png,jpeg');
    		}
...
return redirect('admin/tintuc/sua/'.$id) -> with('thongbao', 'Bạn đã sửa tin thành công');
    ...
    public function getXoa($id)
    {
        $tintuc = TinTuc::find($id);
        $tintuc -> delete ();
        return redirect('admin/loaitin/danhsach')->with('thongbao','Bạn đã xóa tin thành công');
    }
}
